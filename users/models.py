...
class CustomUserManager(BaseUserManager):
    def create_user(self, email, first_name, last_name, password=None, **extra_fields):
        ...
        email = self.normalize_email(email) #Валидация имейла
        user = self.model(email=email, first_name=first_name, last_name=last_name, **extra_fields) #создаю екземпляр модели
    ...
    def create_superuser(self, email, first_name, last_name, password=None, **extra_fields):
        ...
        # Проверка на случай ошибок отсутствия флагов is_staff и is_superuser
